...
function changeModel(){
    let changeMessage = document.getElementById("model-text");
    if (modelName == "XYZ"){
        modelName = "CPRG";
        changeMessage.innerHTML = "Model CPRG";
    }
    else if (modelName == "CPRG"){
        modelName = "XYZ";
        changeMessage.innerHTML = "Model XYZ";
...
function changeDuration(){
    let durationChange = document.getElementById("duration-text");
